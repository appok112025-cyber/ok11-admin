<template>
  <div class="space-y-6">
    <PageHeader title="About" description="Manage about page content">
      <template #actions>
        <SubmitButton
          :loading="isLoading"
          :disabled="!hasChanges"
          ...
          <div class="space-y-4">
            ...
            >
              ...
              <input
                ...
                placeholder="URL (e.g., https://instagram.com/ok11_official)"
              />
            </div>
            <button
              type="button"
...
<script setup lang="ts">
  ...
  import type { AboutData } from '~/types/site-content'
  ...
  const { formData, isLoading, loading, hasChanges, loadData, saveData } =
    useSiteContentForm<AboutData>('about')
